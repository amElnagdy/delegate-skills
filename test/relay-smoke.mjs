 ...
 *                 cases a plain child.kill would miss; agy, aider, kimi, kilo, muse, qoder, vibe, oz, and omp spawn a
 ...
 *                 touchedFiles. Driven for all nineteen relays on POSIX; Windows
 ...
 * A shared matrix also drives all nineteen through the --timeout values no
