 ...
 *                 cases a plain child.kill would miss; agy, aider, kimi, qoder, vibe, oz, omp, and kiro-cli spawn a
 ...
 *                 touchedFiles. Driven for all eighteen relays on POSIX; Windows
 *                 delivers no catchable SIGTERM, so the scenario cannot be
 *                 driven there (the skill docs carry the same caveat). Kiro
